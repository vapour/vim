...
syn region velocityReference oneline start=/\$\!\|\$/                    end=/\>/ skip=+\\(\|\.+ contains=velocityIdentifier,velocityString,velocityNumber
...
syn match velocityDirective "^#[^#].*" contains=velocityString,velocityReference,velocityFormalReference,velocityKeyWord,velocityNumber,velocityInitialSharp,velocityString,velocityLineComment,velocityMultilineComment
...
if version >= 508 || !exists("did_velocity_syntax_inits")
  ...
  HiLink velocityIdentifier              Special
